...
class Master_View_Helper_MasterHelper extends Zend_View_Helper_Abstract {

	public function MasterHelper() {
		return $this;
	}

	public function showStatusMSG( $user_id = 0, $status = 0, $list_read = '' ) {
		if($status < 2) {
			return 'Unread';
		}
	...
	public function showPictureByRank($rank = 0,  $sex = 1) {
